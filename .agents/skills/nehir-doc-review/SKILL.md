...
description: BEFORE writing or updating a discovery, plan, completed write-up, ticket, or other durable document that records a runtime bug, finding, or decision. Checks for ephemeral references, machine-specific paths, unanchored relative language, unsupported claims, and stale status words.
---
